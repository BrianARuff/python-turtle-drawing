# String Functions...
bobo = "This is something InteresSTING"

# .upper()
print(bobo.upper())

# .capitalize()
print(bobo.capitalize())

# .title
print(bobo.title())

print(bobo.replace('s', '$'))
...
print(bobo.isnumeric())
print('99'.isnumeric())

s = "This is a string talking about colour, onlt it spells colour the non-American way. " \
    "Let's change the spelling of colour to the American way."

print(s.replace('colour', 'color'))

# Replace Dumble, Albus and Albus Dumbledore with Ruff, Brian, and Brian Ruff
...
ch_1 = ch_1.replace('Albus', 'Brian').replace('Dumbledore', 'Ruff')
print(ch_1)